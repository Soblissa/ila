...
| **Dokumentationseintrag** | Notiz (Component Set) | Strukturierter Verlaufseintrag zur Dokumentation des Maßnahmenfortschritts — kein Freitext-Notizbuch | Notiz (historisch, ungenau) | Verlauf / Dokumentation | ⚠️ **Bekanntes Problem:** "Notiz" wurde im Pilotbetrieb uneinheitlich verwendet, weil der Begriff zu offen ist. Fachlich korrekt wäre "Dokumentationseintrag" — war dem Design zu lang. Anwender-Begriff und UI-Label müssen neu verhandelt werden. Direkte Auswirkung auf Plugin-Bau: Feldname und Placeholder-Text müssen den richtigen Zweck kommunizieren. | strittig |
